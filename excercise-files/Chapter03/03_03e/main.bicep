...
resource storageResourceGroup 'Microsoft.Resources/resourceGroups@2024-11-01' = {
  name: 'ch3-storage-resources-test-westus2'
...
resource webAppResourceGroup 'Microsoft.Resources/resourceGroups@2024-11-01' = {
  name: 'ch3-webapp-resources-test-westus2'
  location: azureRegion
  tags: {
    Environment: 'Test'
    Project: 'Bicep Demo'
...
module appServiceResource 'appService.bicep' = {
  scope: resourceGroup(webAppResourceGroup.name)
